...
export const FIELD_FILE =
  "relative flex w-full min-w-0 shrink-0 items-center gap-[0.75rem] overflow-hidden rounded-xl border border-dashed border-(--line-strong) bg-(--card) px-[0.9375rem] text-[0.813rem] leading-none text-(--dim) transition-[border-color,color,box-shadow] duration-200 hover:border-[rgba(191,100,231,0.5)] hover:text-(--bright) data-[invalid=true]:border-[rgba(248,113,113,0.55)] h-[2.875rem]";
