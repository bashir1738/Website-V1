        ...
        <div className="mx-auto grid max-w-[920px] gap-10 px-5 py-16 sm:px-7 sm:py-24 md:grid-cols-[170px_1fr] md:gap-16">
          ...
          <div className="max-w-[68ch]">
            ...
            <footer className="mt-16 border-t border-[var(--line-strong)] pt-8">
              ...
              <Link href="/blog" className="mt-5 inline-flex min-h-10 items-center rounded-full bg-[var(--accent)] px-5 text-sm font-semibold text-white transition-colors duration-150 hover:bg-[var(--accent-soft)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--page-bg)]">
                Browse all stories
              </Link>
            </footer>
          </div>
