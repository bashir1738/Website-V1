  ...
  return (
    <main className="relative overflow-hidden">
      ...
      <section className="relative overflow-hidden px-5 pb-16 pt-16 sm:px-7 sm:pt-24">
        ...
        <div className="pointer-events-none absolute right-0 top-1/2 -z-10 w-[420px] max-w-none -translate-y-1/2 translate-x-1/4 select-none opacity-[0.07] transition-opacity sm:w-[560px] lg:w-[650px] lg:translate-x-10 dark:opacity-[0.1]">
          <Image
            src="/brand/zigzag.svg"
            alt=""
            width={710}
            height={733}
            priority
