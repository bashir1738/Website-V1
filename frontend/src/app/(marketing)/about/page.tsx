          ...
          <div className="mt-14 grid gap-6 md:grid-cols-2">
            {[
              ...
              },
              {
                num: "02",
                tag: "Placement",
                title: "Blockfuse Labs Talent Network",
                desc: "Engineers who pass our production-readiness assessment become Blockfuse Labs Verified Engineers. Those approved for employer introductions enter the Blockfuse Labs Talent Network, which is what companies hire from. Others use what they learned to start something of their own.",
                ...
                linkText: "Hire Blockfuse Labs engineers",
              },
              {
                num: "03",
                tag: "Studio",
                title: "Blockfuse Labs Engineering",
