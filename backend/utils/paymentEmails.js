...
const sendStatusLinkEmail = async ({ name, email, track, statusUrl }) => {
  return sendConfirmationEmail({
    to: email,
    subject: 'Your application — next steps — Blockfuse Academy',
    html: wrapEmail({
...
const sendPaymentSubmittedEmails = async ({
  ...
  return Promise.all([
    sendConfirmationEmail({
      to: email,
      subject: 'Payment submitted — awaiting verification — Blockfuse Academy',
      html: wrapEmail({
...
const sendPaymentRejectedEmail = async ({
  ...
  return sendConfirmationEmail({
    to: email,
    subject: 'Payment proof needs attention — Blockfuse Academy',
    html: wrapEmail({
