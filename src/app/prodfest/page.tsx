  ...
  return (
    <main className="relative overflow-hidden pb-20">
      ...
      <section className="px-4 py-8 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="glass group relative overflow-hidden rounded-[2rem] border border-[var(--line)] p-8 sm:p-14 shadow-2xl transition-all duration-300 hover:border-brand-violet/50">
            ...
            <div className="flex flex-col items-center justify-center text-center min-h-[18rem] sm:min-h-[22rem]">
              <div className="inline-flex items-center gap-2 rounded-full border border-[var(--line)] bg-[var(--card-strong)] px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.2em] text-[var(--muted)]">
                Placeholder Showcase
              </div>
              <h3 className="mt-5 font-serif text-3xl font-bold text-[var(--page-fg)] sm:text-4xl">
                ProdFest demo stage
              </h3>
        ...
        <div className="mx-auto max-w-4xl">
          <div className="glass rounded-[2rem] p-8 sm:p-12">
            ...
            <div className="mt-6 space-y-5 text-base leading-relaxed text-[var(--muted)] sm:text-lg sm:leading-8">
              ...
              <div className="rounded-2xl border border-[var(--line)] bg-[var(--card-strong)] p-6 font-semibold text-[var(--page-fg)] leading-relaxed">
      ...
      {/* 4. GET INVOLVED */}
      {/* ========================================================================= */}
      <section id="get-involved" className="px-4 py-20 sm:px-6 lg:px-8 scroll-mt-24">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {/* Attend */}
            <div className="glass group flex flex-col justify-between rounded-[1.8rem] p-7 transition-all duration-300 hover:-translate-y-1.5 hover:border-brand-violet/50 sm:p-8">
              <div>
              ...
              <div className="mt-6 pt-4 border-t border-[var(--line)]">
                <Link
                  ...
                  className="group inline-flex items-center gap-1.5 text-xs font-semibold text-brand-violet hover:underline"
                >
